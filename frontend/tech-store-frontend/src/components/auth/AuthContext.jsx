// contexts/AuthContext.jsx - Add updateProfile function
...
import { 
  ...
  updateProfile as updateProfileService // ✅ Shto këtë import
...
export const AuthProvider = ({ children }) => {
  ...
  // ✅ Shto funksion për update profile
  ...
  const value = {
    ...
    login,
    logout,
    updateProfile, // ✅ Shto këtë funksion
    updateUser,
    checkAuthStatus
  };
